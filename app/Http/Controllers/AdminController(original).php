...
//***** PROJECT_ADD *****//
   ...
   //notification
    ...
    $client = DB::table('client_rep_tbl')->where('cr_delete',1)->get();
    $company = DB::table('client_tbl')->where('cl_delete',0)->get();
      
    	return view('project_add',['id' => $id, 'notif' => $notif, 'notifcount' => $notifcount, 'promanager' => $promanager,'plan' => $plan,'equipcat' => $equipcat,'empPic'=>$empPic, 'client'=>$client,'company'=>$company]);
    }
    ...
    DB::table('client_rep_tbl')->insert([
      ...
      'ci_name' => $_POST['contract-title'],
      'ci_date' => $_POST['contract-date'],
      'ci_signedby' => $_POST['contract-signedby'],
      'cl_no' => $cl_no,
