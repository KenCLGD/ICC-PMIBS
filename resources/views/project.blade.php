            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="width: 41%;height: auto;">
                  <a style="font-size: 1.5rem;">{{$var->pi_title}}</a>
                  <br />
                  <text style="font-size: 1rem;">Created {{$var->proj_created_date}}</text>
                </td>
                <td style="width: 15%;">
