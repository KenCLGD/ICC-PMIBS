                ...
                <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($var->ci_no); ?></td>
                                <td><?php echo e($var->ci_name); ?></td>
                                <td><?php echo e($var->ci_date); ?></td>
                                <td><?php echo e($var->ci_desc); ?></td>
                                <td>
                                    <a href="/previewcontract?id=<?php echo e($var->proj_no); ?>" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="right" title="Generate PDF"><i class="fa fa-download"></i> Generate PDF</a>
                                </td>
                            </tr>
