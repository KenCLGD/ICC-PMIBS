      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" >
            <a href="<?php echo e(url ('indexProjectManager')); ?>" class="site_title" style="text-shadow:5px 5px 5px #222;"><img src="images/logoheader.png" alt="" style="width:100%; height:100%; -webkit-filter: drop-shadow(5px 5px 5px #222); filter: drop-shadow(5px 5px 5px #222); margin-left:-10px;"></span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li>
                  <a href="<?php echo e(url ('indexProjectManager')); ?>"><i class="fa fa-dashboard" style="margin-left:-55px; margin-bottom: 3px;"></i><br>Dashboard </a>
                </li>
                <li>
                  <a href="<?php echo e(url ('PM_project')); ?>"><i class="fa fa-cubes" style="margin-left:-75px; margin-bottom: 3px;"></i> <br>Project </a>
                </li>
                <li>
                  ...
                  <ul class="nav child_menu">
                   <li><a href="<?php echo e(url ('PM_task')); ?>">Project Tasks</a></li>
                   <li><a href="<?php echo e(url ('PM_phase')); ?>">Milestones</a></li>
                 </ul>
               </li>
               <li>
                <a href="<?php echo e(url ('PM_calendar')); ?>"><i class="fa fa-calendar" style="margin-left:-40px; margin-bottom: 3px;"></i> <br>Schedule</a>
              </li>
            </ul>
          </div>
        ...
        <div class="sidebar-footer hidden-small">
          ...
          <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?php echo e(url ('loginpm')); ?>" style="width:100%; height:50px;">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="">
              ...
              <ul class="dropdown-menu dropdown-usermenu pull-right">
                <li><a href="<?php echo e(url ('profilePm')); ?>"> Profile</a></li>
            ...
            <li role="presentation" class="dropdown">
              ...
              <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                ...
                <li>
                  <a href="<?php echo e($notif->notif_pm_url); ?>">
