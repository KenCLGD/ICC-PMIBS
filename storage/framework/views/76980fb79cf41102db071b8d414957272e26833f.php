...
<header>
	...
	<div class="contract-header">
		<p style="font-size: 13px; line-height:150%">
			<strong>Contract No &nbsp; &nbsp; &nbsp; :<strong>&nbsp; &nbsp; <?php echo e($proj->ci_no); ?> <br>
			<strong>Contract Name &nbsp;:<strong> &nbsp; <?php echo e($proj->ci_name); ?>
	...
	<div class="contract-header1">
		...
		<p style="font-size: 15px; line-height:130%; width: 70%; text-align: center; margin-left: 100px;">
			<strong> <?php echo e($proj->pi_title); ?> </strong>
		</p>
	</div>
...
<div class="contract-body">
  ...
  <?php echo e(date("jS", (strtotime($proj->ci_date)))); ?> day of
  <?php echo e(date("F Y", (strtotime($proj->ci_date)))); ?>, at Lingayen,Pangasinan.
  </p>
  ...
  The <?php echo e($client->cl_company); ?>, represented herein by <?php echo e($client->cr_first_name); ?> <?php echo e($client->cr_last_name); ?>

  duly authorized for this purpose, with main office address at <?php echo e($client->cl_address); ?>
  ...
  <p>
  WHEREAS, the EMPLOYER is desirous to have the Works for the project undertaken by Contract: <?php echo e($proj->ci_name); ?>;
  </p>
  <p>
  ...
  <p>
  WHEREAS, the award in the amount of NUMBER IN WORD Only <input type="hidden" id="num" value="<?php echo e($proj->cb_total); ?>"></input> (Php <?php echo e($proj->cb_total); ?>) was accepted by the CONTRACTOR;
  </p>
  <p>
	...
	<tbody style="font-size: 14px;">
		<?php  $plan2 = $plan  ?>
			<?php $__currentLoopData = $plan2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
					<td><?php echo e($plan2->task_id); ?></td>
					<td><?php echo e($plan2->task_description); ?></td>
					<td style="text-align: center;"><?php echo e($plan2->task_unit_cost.' / '.$plan2->task_unit); ?></td>
					<td style="text-align: center;"><?php echo e($plan2->pt_qty); ?></td>
