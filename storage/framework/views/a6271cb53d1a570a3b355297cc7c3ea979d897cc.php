...
<?php $__env->startSection('page_title','Invoice'); ?> 
          ...
          <section class="content invoice">
            ...
            <div class="row">
              <div class="col-xs-12 invoice-header">
                <h1>
                  ...
                  <small class="pull-right">Date: <?php  echo date("m/d/Y", (strtotime("now")))  ?></small>
                </h1>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                ...
                <address>
                  ...
                  <br>Email: <?php echo e($proj->cl_contact); ?>                               
                </address>
              </div>
              <!-- /.col -->
              <div class="col-sm-4 invoice-col">
                ...
                <br>
                <b>Project No:</b> <?php echo e($proj->proj_no); ?> 
                <br>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <form method="post" action="/addprojinvoice">
                      ...
                      <?php $__currentLoopData = $invoicetask; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoicetask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e($invoicetask->pt_id); ?> <input type="hidden" name="pt_id" id="pt_id" value="<?php echo e($invoicetask->pt_id); ?>"></td>
                        <td><?php echo e($invoicetask->task_description); ?></td>
                        <td><?php echo e($invoicetask->task_unit_cost); ?>/<?php echo e($invoicetask->task_unit); ?></td>
                        <td><?php echo e($invoicetask->pt_qty); ?></td>
                        <td>
            ...
            <div class="row">
              ...
              <div class="col-xs-6" style="text-align:center">		
                ...
                <input type="hidden" id="proj_no" name="proj_no" value="<?php echo e($proj->proj_no); ?>">
                <input type="hidden" id="proj_percentage" name="proj_percentage" value="<?php echo e($proj->proj_percentage); ?>">
                ...
                <?php if($terno > 0 && $proj->proj_percentage == 100): ?>
