<?php $__env->startSection('page_title','Task'); ?>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					  ...
					  <?php $__currentLoopData = $var; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <td><?php echo e($var->phase_title); ?></td>
                          <td><?php echo e($var->task_item_no); ?></td>
                          <td><?php echo e($var->task_description); ?></td>
                          <td><?php echo e($var->task_type); ?></td>
                          <td><?php echo e($var->task_unit); ?></td>
                          <td><?php echo e($var->task_unit_cost); ?></td>
                          <td>
                            <button class="btn btn-info btn-xs edittype" data-id="<?php echo e($var->task_id); ?>"><i class="fa fa-pencil"></i> Edit </button>
                            <button class="btn btn-delete deletetype" data-id="<?php echo e($var->task_id); ?>"><i class="fa fa-trash-o"></i> Delete </button>
                          </td>
                        </tr>
					  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
					...
					<form method="post" action="/addtask">
						...
						<div class="form-group col-xs-6">
							...
							<select class="form-control inpTphase" name="task_phase" required>
								...
								<?php  $type2 = $type  ?>
								<?php $__currentLoopData = $type2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($type2->phase_id); ?>"><?php echo e($type2->phase_title); ?> : <?php echo e($type2->phase_description); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
						</div>
						<div class="form-group col-xs-6">
...
<?php echo $__env->make('layouts.dashboardAdmin', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>