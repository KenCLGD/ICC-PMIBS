                      ...
                      <div style="float: left; margin-left: 10%">
                        <div class="col-md-12 col-sm-12 col-xs-24 form-group has-feedback" >
                         ...
                         <select class="form-control client" name="client" required="">
                          ...
                          <optino value="<?php echo e($client->cr_id); ?>"><?php echo e($client->cr_first_name); ?></optino>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div style="float: right;margin-right: 10%">
                      <div class="col-md-12 col-sm-12 col-xs-24 form-group has-feedback" >
                       ...
                       <select class="form-control company" name="company" required="">
                        ...
                        <option value="<?php echo e($company->cl_no); ?>"><?php echo e($company->cl_company); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-24".>
                  ...
                  <div class="form-group col-md-6 col-sm-6 col-xs-12" style="margin-top:1%">
                    ...
                    <select class="form-control" required id="project-manager" name="project-manager">
                      ...
                      <?php $__currentLoopData = $promanager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promanager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($promanager->emp_id); ?>"><?php echo e($promanager->emp_first_name); ?> <?php echo e($promanager->emp_last_name); ?> </option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
        ...
        <div class="modal-body">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12" style="margin-bottom: 5%;">
           ...
           <select class="form-control" id="select_equiptype">
            ...
            <?php $__currentLoopData = $equipcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($equipcat->ec_id); ?>" data-name="<?php echo e($equipcat->ec_category); ?>"><?php echo e($equipcat->ec_category); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
        ...
        <form class="form-horizontal form-label-left input_mask" id="contract_plan">
          <div class="form-group col-md-12 col-sm-12 col-xs-24" style="margin-bottom: 5%;">
            ...
            <select class="form-control" id="select_plan" name="select_plan">
              ...
              <option value="<?php echo e($plan->task_id); ?>"><?php echo e($plan->task_description); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
