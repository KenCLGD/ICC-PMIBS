<?php $__env->startSection('page_title','Project detail'); ?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<div class="col-md-10 col-sm-10 col-xs-22" style="margin-left: 0%; width: 94%">
						<h1 class="lime-text darken-4"><?php echo e($proj->pi_title); ?></h1>
					</div>
                      ...
                      <section class="panel">
                        ...
                        <div class="panel-body" style="margin-top:-27px;">
						  ...
						  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							...
							<ul>
								<li><img src="images/profile/<?php echo e($proj->emp_image); ?>" class="avatar" alt="Avatar"> </li>
								<li style="margin-bottom:-2px">&nbsp;<?php echo e($proj->emp_first_name.' '.$proj->emp_middle_initial.' '.$proj->emp_last_name); ?></li>
							</ul>
                          </div>
								...
								<?php $__currentLoopData = $task; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td style="text-align: center;">
											<span class="new badge <?php if($task->pt_status=='Complete'): ?>  <?php elseif($task->pt_status=='On Going'): ?> orange accent-3 <?php else: ?> lime lighten-5 grey-text <?php endif; ?>" data-badge-caption="" style="font-size:13px;"><?php echo e($task->pt_status); ?></span>
										</td>
									</tr>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</tbody>
							...
							<tbody style="font-size: 14px;">
								...
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<tr style=" border-top: 3px solid gray;">
											...
											<td class="subtotal" style="text-align:right;"><strong>P <?php $number = $plan->cb_total; echo number_format ( $number , "2" , "." , "," )?></strong></td>
										</tr>
										<tr>
											<td colspan="3" align="right" class="quote-align-right" style="color:black; font-size: 16px;"><strong>Received by ALCEL:</strong></td>
											<td class="subtotal bg-green " style="text-align:right"><strong>P <?php $number = $plan->cb_paid; echo number_format ( $number , "2" , "." , "," )?></strong></td>
										</tr>
										<tr>
											<td colspan="3" align="right" class="quote-align-right" style="color:black; font-size: 16px;"><strong>Balance:</strong></td>
											<td class="subtotal bg-red" style="text-align:right"><strong>P <?php $number = $plan->cb_balance; echo number_format ( $number , "2" , "." , "," )?></strong></td>
										</tr>
							</tbody>
						</table>
					...
					<div class="text-center">
                            <?php if($proj->proj_status != 'Closed'): ?><a <?php if($proj->proj_status != 'Closed'): ?> href="/PM_project_edit?id=<?php echo e($proj->proj_no); ?>" <?php endif; ?> class="btn edittype" style="width: 140px; height: 30px; font-size:15px;">Edit Details</a><?php endif; ?>
                    </div>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </div>
...
<?php echo $__env->make('layouts.dashboardPM', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>