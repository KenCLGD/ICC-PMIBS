<?php $__env->startSection('page_title','Project Edit'); ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-24".>
              ...
              <div class="form-group col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                <div class="form-group">
                  ...
                  <input value="<?php echo e($proj->pi_construction_site); ?>" type="text" id="project-site" name="project-site" class="form-control" placeholder="Project Site"  required readonly>
                </div>
              </div>
                  ...
                  <div class="control-group">
                    <div class="controls">
                      <div class="input-prepend input-group">
                        ...
                        <input disabled type="text" name="reservation" id="reservation" class="form-control" value="<?php echo e(date('m/d/Y', strtotime ($proj->proj_start_date))); ?> - <?php echo e(date('m/d/Y', strtotime ($proj->proj_end_date))); ?>" />
                      </div>
                    </div>
                  </div>
                </fieldset>
              ...
              <div class="col-md-12 col-sm-12 col-xs-24 " style="margin-left:40%;">
                <a href="<?php echo e(url ('PM_project')); ?>"><button type="button" class="btn btn-primary" onclick="goBack()">Cancel</button></a>
                    ...
                    <div class="flex">
                      <ul class="list-inline widget_profile_box">
                        <li style="width:75%; margin-top:-8px;">
                          <h3 style="color:#232323; font-size: 1.6em;"><button class="btn btn-primary edittask" type="button"  data-id="<?php echo e($task1->pt_id); ?>"><i class="fa fa-edit"></i></button> <?php echo e($task1->task_description); ?> </h3>
                        </li>
                        <li style="width:25%; text-align:right; margin-top:-7px;">
                          ...
                          <?php else: ?>
                          <h3><span class="label <?php if(strtotime($task1->pt_end_date) < strtotime('now') && $task1->pt_percentage!=100): ?> label-danger <?php elseif($task1->pt_status=='Complete'): ?> label-success <?php elseif($task1->pt_status=='Pending'): ?> label-default <?php else: ?> label-warning <?php endif; ?>"><?php if(strtotime($task1->pt_end_date) < strtotime("now") && $task1->pt_percentage != 100): ?> Delayed <?php else: ?> <?php echo e($task1->pt_status); ?> <?php endif; ?></span></h3>
                          <?php endif; ?>
                        </li>
                        <li style="width:100%">
                      ...
                      <ul class="list-inline count2">
                        ...
                        <li>
                          <span style="color: <?php if($task1->pt_expense > $task1->pt_total_cost): ?> #c60303 <?php else: ?> <?php endif; ?>">
                            Budget:<br><?php echo e($task1->pt_expense); ?> / <?php echo e($task1->pt_total_cost); ?> 
                          </span>
                        </li>
                        <li>
                          <?php if($task1->pt_end_date == '1111-11-11'): ?>
                          ...
                          <?php else: ?>
                          <span>Deadline: <?php echo e($task1->pt_end_date); ?></span>
                          <?php endif; ?>
                        </li>
                      </ul>
                    </div>
    ...
    <div class="col-md-4 col-sm-4 col-xs-8" style="float:right;">
      <div class="x_panel">
        ...
        <div class="x_content well" style="padding:20px">
          ...
          <h4><?php echo e($client->cl_company); ?></h4>
          <h4><strong>Main Contact:</strong></h4>
          <h4><?php echo e($client->cr_first_name); ?> <?php echo e($client->cr_last_name); ?></h4>
          <h4><strong>Email:</strong> <?php echo e($client->cr_email); ?></h4>
          <h4><strong>Telephone
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          <div class="ln_solid" style="margin-top: 8%;"></div>
          <div class="form-group">
            <div class="col-md-12 col-sm-12 col-xs-24 " style="width:100%;">
              <button type="submit" id="editclient" data-id="<?php echo e($proj->proj_no); ?>" class="btn btn-success" style="width:100%">Edit Project Details</button>  
              <a href="/previewcontract?id=<?php echo e($proj->proj_no); ?>"><button class="btn btn-success" style="margin-top: 13px; width:100%">Preview Contract</button></a>
              <a href="/PM_monthlyreport?id=<?php echo e($proj->proj_no); ?>"><button class="btn btn-success" style="margin-top: 13px; width:100%">Monthly Report</button></a>
        ...
        <div class="tab-content">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:center">
                    <span class="label <?php if($equipdep->ei_status=='Maintenance'): ?> label-warning 
                                 <?php elseif($equipdep->ei_status=='Deployed'): ?> label-success 
                                 <?php else: ?> label-danger <?php endif; ?>" 
                  ...
                  <td>
                    <div class="btn-group">
                      <button type="submit" id="editequipment" data-id="<?php echo e($equipdep->ed_id); ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit" style="width:<?php if($equipdep->ei_status!='Deployed'): ?> 50%;
                      <?php else: ?> 100%;
                      <?php endif; ?> text-align:center;">
                        <i class="fa fa-pencil" ></i>
                      </button>
                      <?php if($equipdep->ei_status == 'Maintenance'): ?>
                      <button type="submit" id="equipmentmaintenance" data-id="<?php echo e($equipdep->ed_id); ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Equipment Maintenance" style="width:50%; text-align:center;">
                        <i class="fa fa-wrench" ></i>
                      </button>
                      <?php elseif($equipdep->ei_status == 'Defective'): ?>
                      <button type="submit" id="equipmentrequest" data-id="<?php echo e($equipdep->ed_id); ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Equipment Request" style="width:50%; text-align:center;">
          ...
          <div id="request" class="tab-pane fade">
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  <td><?php echo e($equipreq->req_item_id); ?></td>
                  <td><?php echo e($equipreq->req_items); ?></td>
                  <td><?php echo e($equipreq->req_qty); ?></td>
                  <td>
                    <?php if($equipreq->req_status == 'Sent'): ?>
                    <span class="label label-info" style="font-size: 1.1em"><i class="fa fa-paper-plane-o"> <?php echo e($equipreq->req_status); ?></i></span>
                    <?php elseif($equipreq->req_status == 'Approved'): ?>
                    <span class="label label-success" style="font-size: 1.1em"><i class="fa fa-check"> <?php echo e($equipreq->req_status); ?></i></span>
                    <?php else: ?>
                    <span class="label label-danger" style="font-size: 1.1em"><i class="fa fa-times"> <?php echo e($equipreq->req_status); ?></i></span>
                    <?php endif; ?>
                  </td>
                </tr>
              </tbody>
        ...
        <div class="x_content">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td style="text-align:center"><?php echo e($ter->ter_id); ?></td>
                <td><?php echo e($ter->ter_date); ?></td>
                <td><?php echo e($ter->ter_days); ?></td>
                <td><?php echo e($ter->ter_reason); ?></td>
                <td style="text-align:center"><span class="label <?php if($ter->ter_status=='Waiting'): ?> label-warning <?php elseif($ter->ter_status=='Sent'): ?> label-info <?php elseif($ter->ter_status=='Approved'): ?> label-success <?php else: ?> label-danger <?php endif; ?>" style="font-size: 1.1em"><?php echo e($ter->ter_status); ?></span></td>
              </tr> 
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
          </table>
          <div class="ln_solid"></div>
          <button type="submit" data-id="<?php echo e($proj->proj_no); ?>" class="btn btn-success reqtimeext" style="width:100%"><i class="fa fa-clock-o"></i>&nbsp;Request Time Extension</button>
        </div>
      </div>
    </div>
          ...
          <form method="post" class="form-horizontal form-label-left input_mask" action="/editProjContract" data-parsley-validate>
            ...
            <table class="table table-striped" style="margin-top:6%;">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <a data-toggle="tooltip" data-placement="left" title="Price per unit: <?php echo e($plan1->task_unit_cost); ?>/<?php echo e($plan1->task_unit); ?>  Quantity: <?php echo e($plan1->pt_qty); ?> <?php echo e($plan1->task_unit); ?> ................  Total Cost: <?php echo e($plan1->pt_total_cost); ?>"><?php echo e($plan1->task_description); ?></a>
                  </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
              ...
              <table class="table table-striped">
                ...
                <tbody style="font-size: 14px;">
                  ...
                  <tr>
                    ...
                    <td>₱ <?php $number = $plan->task_unit_cost; echo number_format ( $number , "2" , "." , "," )?>/ <?php echo e($plan->task_unit); ?></td>
                    <td><?php echo e($plan->pt_qty); ?></td>
                    <td>
                      <span><strong>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-24 form-group has-feedback">
					   <label> Assigned Milestone</label>
                        <select class="form-control" id="select_taskphase" name="select_taskphase">
							...
							<?php  $phase2 = $phase  ?>
                            <?php $__currentLoopData = $phase2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($phase2->pp_id); ?>"><?php echo e($phase2->phase_title); ?> : <?php echo e($phase2->phase_description); ?> </option>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </select>
                    </div>
